...
public class SpawnObjectRandomPoints : VisualAction
{
    ...
    {
        if (checkCollisionOnDrag == null) return;
    ...
    protected virtual void Spawning()
    {
        ...
        this.randomTimer = 0;
        if (this.randomPoints == null) return;
    ...
    public GameObject InstantiateRandomGameObject(Vector3 position, Quaternion rotation)
    {
